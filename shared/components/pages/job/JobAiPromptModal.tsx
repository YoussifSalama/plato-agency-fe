...
const aiPromptSchema = z.object({
    ...
    evaluation: z.array(evaluationSchema).min(1, "Add at least one evaluation item."),
});
            ...
            <DialogContent className="max-h-[70vh] overflow-y-auto">
                ...
                <form className="space-y-4" onSubmit={handleSubmit(async (values) => onSubmit(values))}>
                    ...
                    <div className="space-y-3">
                        ...
                        {errors.evaluation && typeof errors.evaluation?.message === "string" && (
                            <p className="text-xs text-red-500">{errors.evaluation.message}</p>
                        )}
                    </div>
